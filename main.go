...
func main() {
	remoteAPIURL := []string{
		"https://gonzoproducts.com/odor-air-magnet-with-activated-charcoal",
		"https://gonzoproducts.com/pet-odor-air-magnet-max-with-activated-charcoal-fragrance-free",
		"https://gonzoproducts.com/odor-air-magnet-with-essential-oils",
		"https://gonzoproducts.com/odor-air-magnet-with-essential-oils-linen",
		"https://gonzoproducts.com/citrus-odor-absorbing-gel",
		"https://gonzoproducts.com/odor-eliminator",
		"https://gonzoproducts.com/pet-hair-lifter",
	}
...
func extractPDFUrls(rawText string) []string {
	...
	requiredKeywords := []string{"gonzoproducts.com", "mwdownloads", "download"}
